...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes (size) {
    ...
    var randomPizzaContainerArray = document.querySelectorAll(".randomPizzaContainer"),
        pClen = randomPizzaContainerArray.length;
...
//使用rAF http://www.cnblogs.com/coco1s/p/5499469.html
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var movingPizzaElement1 =  document.querySelector("#movingPizzas1");
  for (var i = 0; i < 200; i++) {
    ...
    movingPizzaElement1.appendChild(elem);
  }
  // 使用这个函数保持帧率
  updatePositions();
});
