# Udacity-T2-WebSiteOpt

网站性能优化项目

## 访问 

该网站优化结果运行在我的一个VPS服务器上。如果打不开那么请FQ。

请访问[这里](http://smilex.nekohand.moe/z/)

## 优化概述

### index.html

- [评分: 97/100](https://developers.google.com/speed/pagespeed/insights/?hl=zh-CN&url=http%3A%2F%2Fsmilex.nekohand.moe%2Fz%2F)
- 将字体CSS分离, 并直接写入HTML中。
- 将style.css内嵌入HTML中, 因为不多啊。
- 移动main.js到body的末端。
- 其他统计的js加async标签。
- print.css 加media标签
- 网站开启gzip压缩
- 网站设置16d的缓存
- 压缩`views/images/pizzeria.jpg`图片至720px宽度, 使用了imageMagick
- 根据CSS样式, 创建了一个100px宽度的`pizzeria_thumb.jpg` 
