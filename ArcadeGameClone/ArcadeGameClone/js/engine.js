...
/*global UsrWindow, Scoreboard, player, allEnemies, Resources:true*/
...
var Engine = (function(global) {
  ...
  function main() {
    ...
    if(!player.jumpflag){
      ...
      doc.body.innerHTML = '<div>You win the game!!</div>';
    }
  ...
  function init() {
    ...
    var uw = new UsrWindow();
    var scoreboard = new Scoreboard();
    uw.cb = function(){

      console.log('调试信息: 游戏开始');

      player.change(uw.userFigures[uw.choice]);
      player.scoreboard = scoreboard;
      scoreboard.init();
      player.init();


      doc.body.appendChild(scoreboard.obj);
      canvas.width = 505;
      canvas.height = 606;
      ...
      scoreboard.spt = player.col.score;
      scoreboard.item = player.col.item;
      uw.hide();
    };
    uw.loadPics();
    doc.body.appendChild(uw.obj);
